...
- create a module which export a function,
...
const handleNumberThree = () => {
  ...
  button.onclick = async () => {
    let { default: helloWorldFromModule } = await require('./module.js')
    helloWorldFromModule()
  }
}

export { handleNumberOne, handleNumberTwo, handleNumberThree }
